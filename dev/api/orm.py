...
def give_instructions():
    return "Enter a URL containing a query</br>in the format <b>/api/</b><em>&lt;query&gt;</em><b>?lang=</b><em>&lt;en,es,ru,fr...&gt;</em><b>&metric=&lt;rank,counts,freq&gt;&rt=</b>&lt;true,false&gt;</br></br>e.g. <a href='https://storywrangling.org/api/happy new year?metric=freq&rt=false'>https://storywrangling.org/api/<b>happy new year</b>?metric=<b>freq</b>&rt=<b>false</b></a> to get all original tweets (no retweeets)</br>frequency data for the 3-gram <em>happy new year</em> from the ngrams database.</br></br>or</br></br><a href='https://storywrangling.org/api/bonjour?lang=fr&metric=counts&rt=true'>https://storywrangling.org/api/<b>bonjour</b>?lang=<b>fr</b>&metric=<b>counts</b>&rt=<b>true</b></a> to get all count data (including retweeets) for the 1-gram <em>bonjour</em> from the French ngrams database.</br></br>Notes: Emojis are supported! 🐙</br><a href='https://storywrangling.org/api/🐙?metric=rank'>https://storywrangling.org/api/🐙?metric=rank</a></br></br>If we can, we'll try to return the values for a full phrase; if we don't have data for the full phrase, we'll break up your query into 1-grams and return data for each 1-gram. Commas and other delimeters are parsed as words too. </br>For a full explanation of the regex used, consult our documentation,</br>which will be added <a href='https://gitlab.com/compstorylab/storywrangler'>here</a> pending paper publication on the ArXiv."
