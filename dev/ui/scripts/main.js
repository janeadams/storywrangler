...
function showloadingpanel(){
    ...
    d3.select('.pageOverlay').attr('display','block').append('div').attr('class','loader')
}
...
function showAlert(msg){
    ...
    //hideAlert()
    d3.select('.pageOverlay').attr('display','block').append('div').attr('class','alert').html('<p>'+msg+'</p>')
}
