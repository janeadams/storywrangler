...
class Chart {
    ...
    draw() {
        ...
        d3.select(this.element).append('a').attr("id","download").text("Download this data!").attr("href", "https:/storywrangling.org/api/"+params['ngrams'].join(" ")).property("download", true)
