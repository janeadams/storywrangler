...
function addSuplot(ngram){
    ...
    d3.select('#subplots').append('div').attr("class", `subplot-container ${subplotClass}`).append('div').attr("class", "subplot-details").style("color", `${colors.main[ngramData[ngram]['colorid']]}`).html(`<h3>"${ngram}"</h3>`)
