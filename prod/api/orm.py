...
def give_instructions():
    return "Enter a URL containing a query</br>in the format <b>/api/</b><em>&lt;query&gt;</em><b>?lang=</b><em>&lt;en,es,ru,fr...&gt;</em><b>&metric=&lt;rank,counts,freq&gt;&rt=</b>&lt;true,false&gt;</br>e.g. <a href='https://storywrangling.org/api/bonjour%20mon%20ami?language=fr&metric=freq&rt=false'>https://storywrangling.org/api/<b>bonjour mon ami</b>?language=<b>fr</b>&metric=<b>freq</b>&rt=<b>false</b></a> to get all original tweet (no retweeets) frequency data for the 3-gram <em>bonjour mon ami</em> from the French ngrams database.</br></br>Notes: Emojis are supported! 🐙</br><a href='https://storywrangling.org/api/🐙?metric=rank'>https://storywrangling.org/api/🐙?metric=rank</a></br></br>If more than 3 words are entered, they will be parsed as 1-grams. Commas and other delimeters are parsed as words too. </br>For a full explanation of the regex used, consult our documentation,</br>which will be added <a href='https://gitlab.com/compstorylab/storywrangler'>here</a> pending paper publication on the ArXiv."
