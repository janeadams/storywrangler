...
function About() {
  return (
      <section className="about">
          ...
          <p>Sorting frequencies by popularity, we find some n-grams that appear very consistently in time. For example, <a href="https://storywrangling.org/?ngrams=god" target="_blank" rel="noreferrer">&ldquo;god&rdquo;</a> is roughly the 300th most commonly used word each day.  Others rise and fall cyclicly. &ldquo;Friday&rdquo;, &ldquo;New Year&rsquo;s Eve&rdquo;, and &ldquo;Winter Olympics&rdquo; spike every week, year, and four years <a href="https://storywrangling.org/?ngrams=Friday,New%20Year%E2%80%99s%20Eve,Winter%20Olympics" target="_blank" rel="noreferrer">respectively</a>. For one glorious day in 2015, &ldquo;<a href="https://storywrangling.org/?ngrams=%F0%9F%98%8A" target="_blank" rel="noreferrer">&#x1F60A;</a>&rdquo; was the most commonly used word! Many many many more phrases appear very rarely. </p>

          <p>The shapes of our collective attention are quite universal. <a href="https://storywrangling.org/?ngrams=Christmas,Halloween,Thanksgiving,July%204th,Easter" target="_blank" rel="noreferrer">Holiday</a> mentions build exponentially to a crescendo before falling precipitously. <a href="https://storywrangling.org/?ngrams=Avengers" target="_blank" rel="noreferrer">Movies</a> produce a more symmetric pattern centered on their release date. And mentions of individual years reliably plateau chronologically, with a <a href="https://storywrangling.org/?ngrams=2010,2012,2014,2016,2018,2020" target="_blank" rel="noreferrer">volcanic rim</a> bounded by their beginning and end.</p>
          ...
          <p>Share the interesting things you notice! Questions and comments can be sent to <a href="https://twitter.com/storywrangling">Storywrangler on Twitter</a> or via <a href="https://github.com/janeadams/storywrangler" target="_blank" rel="noreferrer">GitHub</a>.</p>
